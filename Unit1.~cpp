...
{
   if(Application->MessageBox("Czy na pewno zamkn¹æ program?", "PotwierdŸ", MB_YESNO | MB_ICONQUESTION)==IDYES)
    {
...
{
      if(Application->MessageBox("Czy na pewno zamkn¹æ program?", "PotwierdŸ", MB_YESNO | MB_ICONQUESTION)==IDNO)
    {
         Action=caNone;
    }
...
void __fastcall TForm1::Opprogramie1Click(TObject *Sender)
{
        Form2->ShowModal();
}
//---------------------------------------------------------------------------
